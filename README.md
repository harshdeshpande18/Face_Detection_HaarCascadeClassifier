...
`OpenCV` contains many pre-trained classifiers for face, eyes, smile etc. The XML files of pre-trained classifiers are stored in `opencv/data/`. For Face Detection Project specifically, the pre-trained Haar Cascade Classifier is used. 
